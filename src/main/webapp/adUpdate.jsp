...
<body>
    ...
    <div class="box-container">
        <div class="white-box">
            <h2>Choose an Advertisement to Update: </h2>
            <br>
            <form action="UpdateAdServlet" method="post" enctype="multipart/form-data">
                <table>
                    <tr>
                        <th>ID</th>
                        <th>Filename</th>
                ...
                <div class="button-container">
                    <button class="button-click" type="submit">Update Selected Ad</button>
                </div>
